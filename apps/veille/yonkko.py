...
SUBCATS = {
    "op-sorties": (
        ...
        "trading card booster box collection",
    ...
    "op-marche": (
        ...
        "rare collectible trading cards",
    ...
    "op-tournois": (
        ...
        "card game tournament players competition",
